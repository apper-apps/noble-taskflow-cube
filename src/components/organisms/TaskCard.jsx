  ...
  return (
    ...
    <div className="flex items-center justify-between mt-3">
        <div className="flex items-center gap-3">
            <PriorityBadge priority={task.priority_c} showPulse={!task.completed_c} />
            {category && <div className="flex items-center gap-1.5 px-2 py-1 rounded-full bg-gray-100">
                <div
